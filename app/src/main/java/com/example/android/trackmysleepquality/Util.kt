...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeInMilli != it.startTimeInMillis) {
                ...
                // Hours
                append("\t ${it.endTimeInMilli.minus(it.startTimeInMillis) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTimeInMilli.minus(it.startTimeInMillis) / 1000 / 60}:")
                // Seconds
                append("${it.endTimeInMilli.minus(it.startTimeInMillis) / 1000}<br><br>")
            }
        }
    }
